...
describe('Service Tests', () => {
    ...
    describe('UsuarioMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(UsuarioMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/usuarios';
                expect(req.request.url).toEqual(resourceUrl + '/' + '123');
            });
            it('should return UsuarioMySuffix', () => {
