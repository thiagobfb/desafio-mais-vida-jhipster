...
import br.med.maisvida.config.audit.AuditEventConverter;
import br.med.maisvida.domain.PersistentAuditEvent;
...
import static br.med.maisvida.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
